...
class ProductManage(models.Model):
    ...
    l_sphere = models.IntegerField(blank=True, null=True)
    l_astigmatic = models.IntegerField(blank=True, null=True)
    l_deviation = models.IntegerField(blank=True, null=True)
    l_add = models.IntegerField(blank=True, null=True)
    l_pd = models.IntegerField(blank=True, null=True)
    r_glasses = models.CharField(max_length=20, blank=True, null=True)
    r_sphere = models.IntegerField(blank=True, null=True)
    r_astigmatic = models.IntegerField(blank=True, null=True)
    r_deviation = models.IntegerField(blank=True, null=True)
    r_add = models.IntegerField(blank=True, null=True)
    r_pd = models.IntegerField(blank=True, null=True)
