...
class ManeuOrderV2(models.Model):
    ...
    guess_id = models.CharField(max_length=38)
    users_id = models.CharField(max_length=38)
    store_id = models.CharField(max_length=38)
    visionsolutions_id = models.CharField(db_column='visionSolutions_id', max_length=38)  # Field name made lowercase.
    subjectiverefraction_id = models.TextField(db_column='subjectiveRefraction_id')  # Field name made lowercase.
